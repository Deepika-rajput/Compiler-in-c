...
Phases
PhaseModuleLexical Analysislexer.cParsing (AST)parser.cSemantic Analysissemantic.cTAC Code Generationcodegen.cOptimizationcodegen.cAssembly Outputcodegen.c
Build & Run
